    ...
    <div className="relative h-screen w-full">
      ...
      <div className="relative h-full flex flex-col justify-center px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto">
          <span className="text-white text-sm tracking-wider mb-4 block uppercase">Cover Story</span>
          <h2 className="text-white text-5xl sm:text-6xl font-bold mb-4">Into the Wild</h2>
